        ...
        <div className="rounded-2xl border border-[#30363d] p-8"
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button type="submit" disabled={loading}
              ...
              style={{ background: loading ? "#1f6feb" : "linear-gradient(135deg, #388bfd 0%, #1f6feb 100%)" }}>
              {loading ? (
          ...
          <p className="mt-5 text-center text-sm text-[#8b949e]">
            ...
            <Link href="/register" className="text-[#388bfd] hover:text-[#58a6ff] font-medium transition-colors">
              Create one
            </Link>
          </p>
        </div>
